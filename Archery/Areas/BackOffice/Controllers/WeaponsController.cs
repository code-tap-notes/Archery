...
namespace Archery.Areas.BackOffice.Controllers
{
    public class WeaponsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]   //un type tokenAntiforeing key. Pour preciser ID sur Html pour securite.
        ...
        [HttpPost, ActionName("Delete")]  //parce que le nom  de methode n'est pas le meme nom de contoleur
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id)  //Ne peut prendre le nome Delete parce que le nom Delete a déjà existé meme paramettre.
        {
            Weapon weapon = db.Weapons.Find(id);
